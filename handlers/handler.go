...
type MessageHandler struct {
	...
	productCache  services.ProductCacheInterface
	supplierCache services.SupplierCacheInterface
	gpt           *openai.ChatGPT
...
func NewMessageHandler(gpt *openai.ChatGPT,
	...
	return &MessageHandler{
		...
		productCache:  services.GetProductCache(),
		supplierCache: services.GetSupplierCache(),
		gpt:           gpt,
		config:        config,
	}
}
