...
type Config struct {
	...
	ProductBitableId           string
	ReceiptBitableId           string
	ReceiptBitableView         string
	SupplierBitableId          string
...
func LoadConfig(cfg string) *Config {
	...
	config := &Config{
		...
		BitableHost:                getViperStringValue("BITABLE_HOST", ""),
		BitableAppToken:            getViperStringValue("BITABLE_APP_TOKEN", ""),
		ProductBitableId:           getViperStringValue("PRODUCT_BITABLE_ID", ""),
		ReceiptBitableId:           getViperStringValue("RECEIPT_BITABLE_ID", ""),
		ReceiptBitableView:         getViperStringValue("RECEIPT_BITABLE_VIEW", ""),
		SupplierBitableId:          getViperStringValue("SUPPLIER_BITABlE_ID", ""),
		OpenaiApiKeys:              getViperStringArray("OPENAI_KEY", nil),
		AliAccessKeyId:             getViperStringValue("ALI_ACCESSKEY_ID", ""),
		AliAccessKeySecret:         getViperStringValue("ALI_ACCESSKEY_SECRET", ""),
